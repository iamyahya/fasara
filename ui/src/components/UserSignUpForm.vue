<template>
  <form v-on:submit="submitForm">
    <h1 class="mt-5 mb-4 d-inline-block">Sign Up</h1>
    or <a class="text-link" @click="$parent.action = 'sign-in'">Sign In</a>
    <div class="form-floating mb-3">
      <input type="code" class="form-control" :class="{'is-invalid': errors.code}" id="form-invite" v-model="form.code" :disabled="loading" required />
      <label for="form-invite">Invite</label>
      <div class="invalid-feedback d-block" v-html="errors.code" v-if="errors.code"></div>
    </div>
    <div class="form-floating mb-3">
